      ...
      routes: [
        {
          ...
          paradas: [
            {
              id: 0,
              stopName: 'All Day Event very long title',
              allDay: true,
            ...
            {
              id: 1,
              stopName: 'Escape from the Dragon',
              startDate: new Date(2018, 3, 7, 12, 0, 0),
            ...
            },
            {
              id: 2,
              stopName: 'DTS STARTS',
              startDate: new Date(2018, 2, 13, 0, 0, 0),
              endDate: new Date(2018, 2, 20, 0, 0, 0),
              priority: 'high',
              lat: 57.002140,
              lng: 93.7321617,
              destination: "Col. Privada Colinas del parque #322 Culiacan, SIN.",
        ...
        {
          id: 2,
          startDate: new Date(2020, 12, 6),
          endDate: null,
          fixedRoute: true,
          routeName: "Ruta las quintas",
          key: "2020-6-12*01",
          duplicatedRoute: false,
          multipleDays: false,
          multipleDrivers: false,
          ...
          paradas: [
              ...
              {
                id: 1,
                stopName: 'Instalar Minisplit casa primavera',
                startDate: new Date(2018, 3, 7, 12, 0, 0),
                endDate: new Date(2018, 3, 10),
                priority: 'high',
                lat: 56.009441,
